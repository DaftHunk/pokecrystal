...
LakeOfRageName:      db "Lac¯Colère@"
SilverCaveName:      db "Grotte¯Argentée@"
...
NationalParkName:    db "Parc¯Naturel@"
TinTowerName:        db "Tour¯Ferraille@"
...
CeruleanCaveName:    db "Caverne¯Azurée@" ; unreferenced
...
IlexForestName:      db "Bois aux¯Chênes@"
BurnedTowerName:     db "Tour¯Cendrée@"
FastShipName:        db "Bateau¯Express@"
ViridianForestName:  db "Forêt¯de Jade@" ; unreferenced
